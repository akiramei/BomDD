# 課題: 検査スクリプトの全ゲートについて「走査母集団が空のときに無音で PASS する」箇所を洗い出す

以下は BomDD リポジトリの自己適合検査 `method/tools/self-conformance.py` の全文です(転写元 revision `a372771bef3c027cc5495f9292b9b85a3a1c92ff`・
sha256 `4eb445b08996ba08dea7254087943f80d3f982c9ee8dc9d60a57ed39c825bb7c`)。この中には `check("Cxx", ok, msg)` で判定を出すゲートが複数あります。
