...
| **未移植** | E14(lifecycle_evidence 宣言・shallow 検査)・E17(fix→accept の祖先順序・逆行乖離)**〔追補 2026-07-26: E17 は ECO-016 の E09 として移植済み — 残は E14 のみ〕** | 7(ECO body)・8(impacted files)・9〜11(視覚 golden)・12(役割分離)・15(hash)・16(known-bad) | E17 は既定 2 状態で発火不能のため見送り→ ECO-016 で移植。7・8 は台帳スキーマ依存、9〜12・15・16 はスコープ外宣言どおり(製品依存設備・様式標準化は OBS-20260725-01 watch) |
