...
> **訂正注記(ECO-056 r3・2026-09-03)**: 本書 §1 user_rulings 行と §3 所見 3 の「導出可能な転写値」は未証明(ruling ID・集計規則が
> 未定義 — Codex 独立検査 ECO055-IA-07)。削除根拠は **consumer 不在**に限定する(52 テンプレの注記が正)。本文は歴史的記録として書き換えない。
