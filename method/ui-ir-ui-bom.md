...
これは「見た目の微差」ではなく、**デザインシステム部品が E-BOM/K-BOM に未構築だった**ことに起因する製造不適合である。E1〜E7 の業務スライスが正しくても、E-DESIGN-028 / K-DESIGN 相当の Card / CTA / Chip / Badge / IconButton などの surface 部品が無いと、実機は薄い素実装に退化する。
